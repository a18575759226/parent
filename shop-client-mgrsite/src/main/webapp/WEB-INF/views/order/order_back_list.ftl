...
<#include "../common/header.ftl"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //确认退货订单
            $(".confirm_back_order").click(function () {
                var oid = $(this).data("json");
                $.ajax({
                    url: "/confirm_back_order.do",
                    dataType: "json",
                    type: "POST",
                    data: {orderId: oid},
                    success: function () {
            ...
            $(".back_order").click(function () {
                var oid = $(this).data("json");
                window.location.href = "/order_back_item.do?orderId=" + oid;
            });
        })
    </script>
</head>
...
<#include "../common/top.ftl"/>
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <form id="searchForm" class="form-inline" method="POST" action="/order_back_list.do">
            ...
            <table class="table">
                ...
                <#list PageResult.listData as map >
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:;" class="back_order" data-json="${map['orderId']}"
                               data-tojson='${map['orderCollect']}'>${map['orderCollectId']}</a></td>
                        <td><a href="javascript:;" class="confirm_back_order" data-json="${map['orderId']}">确认退货单</a>
                        </td>
                    </tr>
                    </#if>
                </#list>
