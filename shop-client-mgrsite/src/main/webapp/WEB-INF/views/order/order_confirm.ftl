...
<#include "../common/top.ftl"/>
    <div class="row">
        ...
        <div class="col-sm-9">
            <form id="searchForm" class="form-inline" method="POST" action="/order_confirm_list.do">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>${map['consignee']}</td>
                    <td>${map['address']}</td>
                    <td><a href="javascript:;" id="confirm_order" data-json="${map['orderId']}">确认订单</a></td>
                </tr>
                </#list>
                </tbody>
