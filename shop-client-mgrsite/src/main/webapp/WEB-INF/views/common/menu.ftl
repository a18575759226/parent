<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="product_list">
			<li class="add_product"><a href="/addProduct.do">商品录入</a></li>
			<li class="product_list"><a href="/productList.do">商品列表</a></li>
			<li class="catalog"><a href="/catalog.do">分类管理</a></li>
			<li class="catalogProperty"><a href="/catalogProperty.do">分类属性管理</a></li>
			<li class="skuProperty"><a href="/skuProperty.do">sku属性管理</a></li>
    ...
    <li class="list-group-item">
        ...
        <ul class="in" id="product_list">
            <li class="add_product"><a href="/orderList.do">订单列表</a></li>
            <li class="product_list"><a href="/productList.do">发货单列表</a></li>
            <li class="catalog"><a href="/catalog.do">退货单列表</a></li>
            <li class="catalogProperty"><a href="/catalogProperty.do">缺货登记</a></li>
            <li class="skuProperty"><a href="/skuProperty.do">销售量报表</a></li>
            <li class="oederInfo"><a href="/oederInfo.do">访问量列表</a></li>
        </ul>
    </li>
	<li class="list-group-item">
